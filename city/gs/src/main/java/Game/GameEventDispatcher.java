...
public class GameEventDispatcher extends DispatcherBase {
	...
	private GameEventDispatcher(){
		try {
			...
			table.put((short) GsCode.OpCode.queryMyBrandDetail_VALUE, Wrapper.newWithMessageAsync(Gs.UpdateMyBrandDetail.PARSER, GameSession.class,"updateMyBrandDetail"));
