...
public class GameEventDispatcher extends DispatcherBase {
	...
	private GameEventDispatcher(){
		try {
			...
			table.put((short) GsCode.OpCode.updateMyBrandDetail_VALUE, Wrapper.newWithMessageAsync(Gs.UpdateMyBrandDetail.PARSER, GameSession.class,"updateMyBrandDetail"));
