...
public class TopInfo {
    ...
    public TopInfo(UUID pid,String name, long yesterdayIncome, int workerNum, long science, long promotion) {
        this.pid = pid;
        this.name = name;
    ...
    public TopInfo(UUID pid, String name,long total, int count) {
        this.pid = pid;
        this.name = name;
